...
class ApiResponse:
    ...
    def get_available_hardwares(self):
        url = self.url + "analyses/"
        return self.send_get(url, self.api_key)

    @staticmethod
    def send_get(url, api_key, timeout=60):
        """
        ...
        ApiResponse.check_response(response)
